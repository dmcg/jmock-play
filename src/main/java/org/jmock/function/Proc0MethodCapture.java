...
public class Proc0MethodCapture<X extends Throwable> extends BaseMethodCapture<Proc0MethodCapture.Proc0Will<X>> {
    ...
    public static class Proc0Will<X extends Throwable> extends BaseWill {
